...
public class CheckingAccount extends Account {
    ...
    public boolean initAccount() {
        ...
        System.out.println(
                "Opening this count will charge you 5 dollars. Make sure you have created the saving count and save at least 5 dollars in it.");
        System.out.println(
                "Although you can use 3 types of currency in our bank(Dollar, RMB and Pound), you need to pay dollars this time.");
    ...
    public boolean checkMoney(String type, String cash) {
        ...
        if (success) {
            ...
            success = currency.sub(type, Double.parseDouble(cash), "1");
            if (!success) {
                createTransaction("0", type, "Failed to make a check.");
                return false;
            }
            else {
            ...
            System.out.println(
                    "Failed to make a checking due to lack of dollars.");
    ...
    public boolean checkMoney() {
        ...
        if (success) {
            ...
            currency.toString();
            System.out.println(
                    "Choose a currency type you want to trade: 1. Dollar 2. RMB 3. Pound");
            ...
            if (number1 == 1) {
                System.out.println(
                        "How much cash would this check value? Please make sure that you don't write checks bigger than your deposit.");
