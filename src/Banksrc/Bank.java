...
public class Bank {
    ...
    public static void userMenu() {
        userend = true;
        System.out.println(
                "You are 1. new customer 2. old customer 3. new manager 4. old manager 5. exit");
    ...
    public static void bankMenu(int id) {
        ...
        System.out.println(
                "1. check 2. save/withdraw 3. loan 4. delete accounts 5. exit");
        Scanner choice = new Scanner(System.in);
        String num = choice.nextLine();
        while (!Tool.is_number(num)) {
            System.out.println("Invalid input. Input again.");
            ...
            case 1: {
                ...
                if (exist < 0) {
                    ...
                    if (accountID >= 0) {
                        ...
                        ((CheckingAccount) customers.get(id).accounts.get(
                         accountID)).Menu(customers.get(id));
                    }
                }
                else {
                    ((CheckingAccount) customers.get(id).accounts.get(exist)).Menu(
                            customers.get(id));
                }
            }
            case 2: {
    ...
    public static void managerMenu() {
        System.out.println("Choose an action you wanna take: ");
        System.out.println(
                "1. check all the customers 2. search for one customer 3. check for debtors 4. exit");
        Scanner choice = new Scanner(System.in);
        String num = choice.nextLine();
        while (!Tool.is_number(num)) {
            System.out.println("Invalid input. Input again.");
    ...
    public static int isthereAccount(int id, String str) {
        ...
        if (accountID < 0) {
            System.out.println(
                    "You don't have " + str + " account it. You can create one now.");
        }
        return accountID;
    }
